...
laughing are based on naturally occurring phenomena governed by the laws of physics
and chemistry. This is a good thing for biologists because theses processes can be studied scientifically.
...
cells (and organisms), through an unbroken chain of life. There was a
...
were generated by the processes of evolution, which include: gene and
...
difficult to apply to life-forms like microbes. Defining species can be
...
contain over 1014 (trillions) distinct cells (like yourself).
...
form an "enteric" ecosystem
["enteric" ecosystem"](http://www.ncbi.nlm.nih.gov/pubmed/21787875). You can look
outside to see another ecosystem in action.
...
body of the organism, and perform specific roles like: digestion of
food, production of energy (ATP; see below), movement, cognitive
...
your body are the actions and function of your cells. Then, you
shouldn’t be too surprised that we will spend most of our time in this
course trying to understand the function of cells.
...
unbroken chain of life that goes back \~4 billion years. In analogy with
...
Replication, transcription, and translation require energy to occur as
do all chemical reactions. This energy is captured from the external
world; from outside the cell and ultimately from outside of you
(hamburgers are a great source of energy). Cells store much of this

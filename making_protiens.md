...
that builds an RNA molecule using a DNA molecule. 
...
 
![Relationship between genome sizes and GC content of 358 complete genomes from Bacteria 
and Archaea. In the insert, the tubular structures are *Carsonella* living inside a cell 
of a phloem sap-feeding insect *Pachypsylla venusta* - the host cell's nucleus is the 
larger blue oval](./img/Carsonella.jpg)

Figure:Relationship between genome sizes and GC content of 358 complete genomes from Bacteria 
and Archaea. In the insert, the tubular structures are *Carsonella* living inside a cell 
of a phloem sap-feeding insect *Pachypsylla venusta* - the host cell's nucleus is the 
larger blue oval
...
![Transcription factors (purple proteins) bound to DNA](./img/transcription_factors.gif)
...
![ ](./img/polymeraseLoading1.jpg)]_![ ](./img/polymeraseLoading2.jpg)
...
7. Which molecule(s) actually do the translating? 
